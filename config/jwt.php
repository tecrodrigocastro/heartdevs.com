...
return [
    ...
    */
    ...
    'refresh_iat' => env('JWT_REFRESH_IAT', default: false),
    'refresh_ttl' => (int) env('JWT_REFRESH_TTL', 20_160),
    ...
    */
    ...
    'blacklist_enabled' => env('JWT_BLACKLIST_ENABLED', default: true),
    ...
    */
    ...
    'show_black_list_exception' => env('JWT_SHOW_BLACKLIST_EXCEPTION', default: true),
